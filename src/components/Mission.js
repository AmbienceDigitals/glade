...
const Mission = () => {
  return (
    <div className="w-screen mt-8 px-8 text-md  md:px-10 md:text-lg lg:px-16 lg:text-xl">
        <h1 className="p-5 text-center text-2xl uppercase font-medium text-gray-500 md:text-3xl lg:text-3xl">Mission Statement</h1>
        <p>At Glade Foundation, we are committed to providing quality support for people affected by post COVID-19 economic incoveniences in all forms</p>
